...
def updateWithDate(dtype='D', export='csv', path='history',dateStart='2014-01-09',dateEnd='2015-01-09',stock_codes='000001'):
    return Day(path=path, export=export).updatewithDate(dateStart,dateEnd,stock_codes)
