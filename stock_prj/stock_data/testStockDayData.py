...
#stockcode = ['000001']
stock_get_day_data.updateWithDate(path='./stockdata/stocktradedata/', export='csv',dateStart='2014-01-09',dateEnd='2018-07-29',stock_codes=stockcode)
stock_process_day_data.stock_trade_preprocess(export='csv',path_data='./stockdata/stocktradedata', path_result='./stockdata/pctdata',dtype='D',\
                           start_date='2014-01-01',end_date='2018-07-29', stocks=stockcode)
